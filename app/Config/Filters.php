...
class Filters extends BaseConfig
{
    ...
    public $globals = [
        'before' => ['passwordprotect',
            ...
            // 'invalidchars',
            'isLoggedIn'    => ['except' => ['/', 'Auth/*','Providerauth/*','Providersearch/*','provider/*','provider_gallery/*','providers','providers/*', 'api/*', 'blocked', 'maintenance','about-us','faq','update_call_count/*','update_direction_count/*','pricing','blog','blog_detail/*','testimonials','contact','submit-contact','terms','privacy','how-it-works','find-a-provider','common/send_message_to_provider','cron/*','welcome_mail','confirm_mail','reminder_mail','common/getProfileViews']],
            'isGranted'     => ['except' => ['/', 'Auth/*', 'Providerauth/*','Providersearch/*','provider/*','provider_gallery/*','providers','providers/*','api/*', 'blocked', 'maintenance','about-us','faq','update_call_count/*','update_direction_count/*','pricing','blog','blog_detail/*','testimonials','contact','submit-contact','terms','privacy','how-it-works','find-a-provider','common/send_message_to_provider','cron/*','welcome_mail','confirm_mail','reminder_mail','common/getProfileViews']],
            'isMaintenance' => ['except' => ['Auth/*', 'api/*','Providerauth/*','Providersearch/*','provider/*','provider_gallery/*','providers','providers/*', 'blocked', 'admin/*', 'maintenance','about-us','faq','update_call_count/*','update_direction_count/*','pricing','blog','blog_detail/*','testimonials','contact','submit-contact','terms','privacy','how-it-works','find-a-provider','common/send_message_to_provider','cron/*','welcome_mail','confirm_mail','reminder_mail','common/getProfileViews']],
        ],
        'after' => [
            'toolbar',
            // 'honeypot',

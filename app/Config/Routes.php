...
$routes->group("providerauth", ["namespace" => "App\Controllers\Providerauth"], function ($routes) {
    ...
    $routes->get('register', 'ProviderRegister::index');
    $routes->post('register-post', 'ProviderRegister::provider_register_post');
    ...
    $routes->get('plan', 'ProviderRegister::plan');	
    ...
    $routes->post('check-email', 'ProviderRegister::check_email');
...
$routes->group("admin", ["namespace" => "App\Controllers\Admin"], function ($routes) {
    ...
    $routes->group('categories', function ($routes) {
        ...
        $routes->get('offering/(:any)', 'Offering::index/$1');    
        $routes->post('offering/saved_offering_post', 'Offering::saved_offering_post');
        $routes->post('offering/delete_offering_post', 'Offering::delete_offering_post');   
    });

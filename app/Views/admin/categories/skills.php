            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-skills">
                                <div class="tab-pane fade show active" id="custom-tabs-skills" role="tabpanel" aria-labelledby="custom-tabs-skills-tab">
                                    <div class="table-responsive">
                                        <table id="skills_table" class="table table-bordered table-striped nowrap w-100 pageResize">
                                            <div class="row table-filter-container">
                                                <div class="col-sm-6">
                                                    <?php $request = \Config\Services::request(); ?>
                                                    <?php echo form_open(admin_url() . "skills/".$categoryId, ['method' => 'GET']); ?>
                                                ...
                                                <div class="col-sm-6 text-right">
                                                    <a href="javascript:void(0)" class="btn bg-primary" onclick="manage_skills('<?php echo html_escape($categoryId); ?>','','');"><i class="fa fa-plus pr-2"></i><?php echo trans("add"); ?></a>
                                                </div>
                                            </div>
                                            <thead>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="dropdown btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-animated">
                                                                    <a class="dropdown-item" href="javascript:void(0)" onclick="$('#modal-modalLabel').text('<?php echo trans('edit'); ?>'); manage_skills('<?php echo html_escape($categoryId); ?>','<?php echo html_escape($item->id); ?>','<?php echo html_escape($item->name); ?>');"><?php echo trans('edit'); ?></a>
                                                                    <div class=" dropdown-divider">
                                                                    </div>
                                                                    <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('/admin/skills/delete_skills_post','<?php echo $item->id; ?>','<?php echo trans('confirm_delete'); ?>');"><?php echo trans('delete'); ?></a>
                                                                </div>
                                                            </div>
...
<!-- Modal -->
<div id="modal-skills" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form_safe" action="<?php echo admin_url() .'skills/saved_skills_post';?>" method="post">
...
function manage_skills(categoryId,id,name) {

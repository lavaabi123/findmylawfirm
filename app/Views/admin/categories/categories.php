                                                        ...
                                                        <td class="text-center">
                                                            <div class="dropdown btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-animated">
                                                                     <a class="dropdown-item" href="<?php echo admin_url() .'skills/index/'.html_escape($item->id);?>"><?php echo trans('Manage Skills'); ?></a>
                                                                     <div class=" dropdown-divider"></div>
																	 <a class="dropdown-item" href="<?php echo admin_url() .'offering/index/'.html_escape($item->id);?>"><?php echo trans('Manage Offering'); ?></a>
                                                                     <div class=" dropdown-divider"></div>
                                                                    <?php if ($item->status == 1) : ?>
...
<div id="modal-categories" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form_safe" action="<?php echo admin_url() .'categories/saved_categories_post';?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label><?php echo trans("rate_type"); ?></label>
                        <input type="text" id="modal_rate_type" name="rate_type" maxlength="50" class="form-control form-input" placeholder="<?php echo trans("rate_type"); ?>" required>
                    </div>        

                    <div class="form-group">
                        <label><?php echo trans("skill_name"); ?></label>
                        <input type="text" id="modal_skill_name" name="skill_name" maxlength="50" class="form-control form-input" placeholder="<?php echo trans("skill_name"); ?>" required>
                    </div>        

                    <div class="form-group">
                        <label><?php echo trans("in_house"); ?></label>
                        <input type="text" id="modal_in_house" name="in_house" maxlength="30" class="form-control form-input" placeholder="<?php echo trans("in_house"); ?>" required>
                    </div>        
    ...
    if(categoryId != ''){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#modal_rate_type').val(obj.rate_type);
                $('#modal_skill_name').val(obj.skill_name);
                $('#modal_in_house').val(obj.in_house);

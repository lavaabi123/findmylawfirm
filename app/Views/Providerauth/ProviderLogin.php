        ...
        <div class="container py-md-4">
                ...
                <form id="form_safe" class="form-input" action="<?php echo base_url(); ?>/providerauth/login-post" method="post">
                    ...
                    <small class="d-flex justify-content-between flex-column align-items-center flex-sm-row">
						<a class="dblue" href="<?php echo base_url() ?>/providerauth/forgot-password"><?php echo trans('forgot_password') ?></a>
						<p class="text-muted mb-0">Don't have an account? <a href="<?php echo base_url(); ?>/providerauth/register" class="text-muted"><?php echo trans("register"); ?></a></p>
					</small>

                    <div class="row mt-3 mt-sm-4 align-items-center text-center text-sm-start flex-column-reverse flex-sm-row">
                        ...
                        <!-- /.col -->
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-lg btn-block w-100"><?php echo trans("login"); ?></button>
                        </div>
                        <!-- /.col -->
                    </div>
					</div>

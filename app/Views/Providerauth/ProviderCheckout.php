...
<?= $this->section('content') ?>
    <div class="plan bg-gray pt-2 pb-4 pb-xl-5">
		...
		<div class='row'>
			...
			<a class="btn yellowbtn float-right my-4 my-md-0" href="<?php echo base_url('providerauth/plan'); ?>">CHANGE PLAN</a>
			</div>
		</div>
			<hr>
			<div class='row'>
			  ...
			  <?php } ?>
				...
				<div class='col-12 col-sm-6'>
					<table class="table table-striped" width="100%">
						...
						<?php } ?>
							<tr><td><b>About (Me/Us)</b><div>(Tell customers who you are in your own words)</div></td><td class="text-center"><i class="fa fa-check"></i></td></tr>
							<tr><td><b>Add a Phone Number</b><div>(Gain a business advantage by including a direct phone number)</div></td><td class="text-center"><i class="fa fa-check"></i></td></tr>
							<?php if($plan_detail[0]->id != 2){ ?>
							...
							<?php } ?>
							<tr><td><b>Website Links</b><div>(Lead customers to your personal/business website)</div></td><td class="text-center"><i class="fa fa-check"></i></td></tr>							
							<tr><td><b>Include Rates/Fees</b><div>(Adjust and display current rates for your services)</div></td><td class="text-center"><i class="fa fa-check"></i></td></tr>
							<tr><td><b>Hours of Operations</b><div>(Let customers know when you're available)</div></td><td class="text-center"><i class="fa fa-check"></i></td></tr>

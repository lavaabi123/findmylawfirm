		...
		<div class="row row-cols-1 row-cols-sm-3 g-4 pb-3">			
			<div class="col">
				<div class="bg-white">
					...
					<h6 class="dblue title-sm">- Susan V.</h6>
				</div>
			</div>
			<div class="col">
				<div class="bg-white">
					...
					<h6 class="dblue title-sm">- Mary S.</h6>
				</div>
			</div>
			<div class="col">
				<div class="bg-white">
					...
					<h6 class="dblue title-sm">- Stephen M.</h6>
				</div>
			</div>
			<div class="col">
				<div class="bg-white">
					<img src="<?= base_url('assets/frontend/images/stars.png') ?>">
					<p>As a proud dog parent, I was thrilled to discover FindMyGroomer.com. The site not only boasts a comprehensive directory of groomers but also ensures that finding availability is a breeze. A must-try for all pet owners seeking a seamless grooming experience.</p>
					<h6 class="dblue title-sm">- Karin M.</h6>
				</div>
			</div>
			<div class="col">
				<div class="bg-white">
					<img src="<?= base_url('assets/frontend/images/stars.png') ?>">
					<p>Finally a dog website that truly cares and is dedicated to dog owners! </p>
					<h6 class="dblue title-sm">- Joel T.</h6>
				</div>
			</div>
			<div class="col">
				<div class="bg-white">
					<img src="<?= base_url('assets/frontend/images/stars.png') ?>">
					<p>Discovering FindMyGroomer.com was a blessing. The platform's directory is a goldmine for finding skilled groomers, and the availability feature is a godsend. Now, grooming sessions are stress-free, and my dog looks forward to them. Kudos for simplifying the grooming process!</p>
					<h6 class="dblue title-sm">- Liliana E.</h6>
				</div>
			</div>
				...
				<div class="col">
					<div class="bg-white">
						<img src="<?= base_url('assets/frontend/images/stars.png') ?>">
						<p>FindMyGroomer.com exceeded my expectations. The site not only helped me find a groomer who understands my dog's unique needs but also makes scheduling appointments a breeze. The convenience it offers is unparalleled. I'm a happy customer and a happy dog owner!DD4RX</p>
						<h6 class="dblue title-sm">- Heather R.</h6>
					</div>
				</div>
		</div>
	</div>
